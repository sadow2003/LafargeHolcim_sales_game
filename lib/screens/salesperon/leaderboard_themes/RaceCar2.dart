...
_LaneMetrics _laneAt(double h, int index){
  const grassFractions = 0.05;
  const gapFractions = 0.025;
  final totalTrackH= h * (1 - grassFractions * 2) - (2 * h * grassFractions);
  final laneH = totalTrackH /3;
  final top = h * grassFractions + index * (laneH + h * gapFractions);
...
class RaceCarPodium extends LeaderboardPodium {
  ...
  static const _carAssets =[
    'assets/racecar_theme/car_red.svg',
    'assets/racecar_theme/car_yellow.svg',
    'assets/racecar_theme/car_blue.svg',
  ];
        ...
        child: Stack(
          children: [
            ...
            ...player.map((player){
              ...
              final carH = lm.laneH * 0.6;
              final carW = carH;
              final carDispH = carH * 0.8;
              final badgeR = lm.laneH * 0.25;
              final startX = badgeR * 2 + carW /2;
              final finishX = w * 0.915;
