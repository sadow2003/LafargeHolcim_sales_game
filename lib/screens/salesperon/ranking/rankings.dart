...
class _RankingsPageState extends State<RankingsPage>
  ...
  void initState() {
    ...
    // Listen to the event doc; schedule a one-shot timer to flip _eventEnded
    // at exactly the moment the endDate passes — no per-second rebuilds.
    _eventSub = FirebaseFirestore.instance
      ...
      if (endDate == null) {
        // Event was deleted; hide overlay if it was showing.
